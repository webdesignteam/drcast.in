                                        ...
                                        <div class="customtable">
                                            <div class="customtable">
                                                <table id="myTable">
                                                    ...
                                                    <tbody id="searchtbl">
                                                        <?php //echo "<pre>"; print_r($enrollmentlist); ?>
                                                            <?php if(empty($enrollmentlist)) { ?><tr><td class="text-center">No data</td></tr><?php } else { ?> <?php $idnumbers='0' ; foreach($enrollmentlist as $enrollment_list) { $idnumbers++ ?>
                                                        <tr>
                                                            <td><?php echo $enrollment_list['wc_r_name']; ?></td>
                                                            <td><?php echo $enrollment_list['wc_r_email']; ?></td>
                                                            <td><?php echo $enrollment_list['wc_r_mobile']; ?></td>
                                                            <td><?php echo $enrollment_list['wc_r_mci_number']; ?></td>
                                                            <td><?php echo $enrollment_list['wc_r_speciality']; ?></td>
                                                            <td><?php echo date('d M Y h:i A',strtotime($enrollment_list['wc_e_enroll_status']));?></td>
                                                        </tr>
                                                        <?php } ?> <?php } ?>
                                                    </tbody>
                                                </table>

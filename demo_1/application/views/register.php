                ...
                <div class="col-sm-4">
                    <div class="registration-form">
                        ...
                        <form class="form-horizontal" method="post" name="register" id="register"
                            ...
                            <?php if($webinarinfo[0]['re_drcode'] == "Yes"){ ?>
                            <div class="form-group">
                                <label>Dr. Code</label>
                                <input type="text" autocomplete="off" class="form-control" placeholder="Can we have your digits?" id="drcode" name="drcode">
                            </div>
                            <?php } ?>
    ...
    $(function() {
        $("#register").validate({
            ...
            messages: {
                ...
                mcinumber: {
                    required: "Enter your Medical Council registration number",
                },
                designation: {

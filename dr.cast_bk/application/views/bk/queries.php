                                ...
                                <form id="filters1" name="filters1" method="post" class="md_filters"
                                    ...
                                    <div class="middle_flt datebtn">
                                        <i class="fa fa-calendar"></i>&nbsp;<span></span> <i
                                            class="fa fa-caret-down"></i><input id="daterangepicker" type="text"
                                            name="daterange" value="" placeholder="Select Date"
                                            class="dtrangeinput valid" aria-invalid="false">
                                    </div>
                                        ...
                                        <div class="customtable">
                                            <div class="customtable">
                                                <table id="myTable">
                                                    ...
                                                    <tbody id="searchtbl">
                                                        <?php //echo "<pre>"; print_r($querieslist); ?>
                                                            <?php if(empty($querieslist)) { ?><tr><td class="text-center">No data</td></tr><?php } else { ?> <?php $idnumbers='0' ; foreach($querieslist as $querieslist) { $idnumbers++ ?>
                                                        <tr>
                                                            <td>
                                                                <p><?php echo $querieslist['Que_autoID']; ?>  </p>
                                                            </td>
                                                            <td>
                                                                <p>
                                                                    <b>Query : <?php echo $querieslist['Que_Query']; ?></b> <a data-toggle="tooltip" title="" data-original-title="Copy URLs" href="#" onclick="CopyToClipboard('<?php echo $querieslist['Que_Query'];?>');return false;"><i class="fa fa-files-o enquiry_copy" aria-hidden="true"></i></a> 
                                                                </p>
                                                                <p>Webinar : <?php echo $querieslist['webinar_topic']; ?> </p>
                                                                <p class="title_date">Query by : <?php echo $querieslist['Que_name']; ?> , Query created on : <?php echo $querieslist['Que_createdOn']; ?></p>
                                                            </td>  
                                                        </tr>
                                                        <?php } ?> <?php } ?>
                                                    </tbody>

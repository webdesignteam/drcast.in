                                                ...
                                                <div class="customtable_main">
                                                    <div class="customtable scroll_table">
                                                        <table id="myTable">
                                                            ...
                                                            <tbody id="searchtbl">
                                                                <?php if(!empty($userslogs)) { $i=0; foreach($userslogs as $userslog_list) { $i++; ?>
                                                                    <tr>
                                                                        <td><?php echo $i; ?></td>
                                                                        <td><?php echo $userslog_list['wc_u_code']; ?></td>
                                                                        <td><?php echo $userslog_list['username'].' - '.$userslog_list['wc_u_empid']; ?></td>
                                                                        <td><?php echo $userslog_list['wc_di_code']; ?></td>
                                                                        <td><?php echo $userslog_list['wc_logon']; ?></td>
                                                                        <td><?php echo $userslog_list['wc_logout']; ?></td>
                                                                    </tr>
                                                                <?php } } ?>
                                                            </tbody>
                                                        </table>

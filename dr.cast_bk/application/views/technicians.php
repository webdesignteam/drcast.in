            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <form id="techinacian_mapping" method="post" class="payment-form">
                                        <div class="table_content top_cusmo_form">
                                            <div class="row center_div_rows">
                                                <div class="col-sm-12 mb-20">
                                                    <h5 class="page_sub_txt">Technician to Division Maping</h5>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="wc_u_code" name="wc_u_code">
                                                            ...
                                                            <?php if(empty($technicians)){ echo '<option value="">No Data</option>'; }else { ?>
                                                                ...
                                                                <?php foreach($technicians as $technician_list) {?>
                                                                    <option value="<?php echo $technician_list['wc_u_code']; ?>"><?php echo $technician_list[ 'wc_u_display_name']; ?></option>
                                                                <?php } ?>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-sm-4">
                                                  ...
                                                  <div class="col-sm-4">
                                                <input type="submit" class="btn custom_add" id="submit" name="technician_to_division_maping"  value="Submit">
                                                 </div>
                                            ...
                                            <div class="customtable scroll_table">
                                                ...
                                                <table id="myTable">
                                                    <thead>
                                                     ...
                                                     <tbody id="searchtbl">
                                                        <?php //print_r($users); ?>
                                                        <?php  if(empty($technicianinfo)) { } else { ?> 
                                                        <?php $i = 0; foreach($technicianinfo as $technicianinfo_list) {  $i++;?>
                                                            <tr>
                                                                <td><?php echo $i; ?></td>
                                                                <td><?php echo $technicianinfo_list['wc_u_display_name']; ?></td>
                                                                <td><?php echo $technicianinfo_list['wc_u_email']; ?></td>
                                                                <td><?php echo $technicianinfo_list['wc_u_phone']; ?></td>
                                                                <td><?php echo $technicianinfo_list['wc_di_name']; ?></td>
                                                            </tr>
                                                        <?php } ?>
                                                        <?php } ?>
                                                    </tbody>

                        ...
                        <table id="example" class="table table-bordered table-striped table-sm">
                            <thead>
                                <tr>
                                    ...
                                    <?php if($webinarinfo[0]['re_mci'] == "Yes"){ ?><th>Dr. Code</th><?php } ?>
                                    <?php if($webinarinfo[0]['re_div_name'] == "Yes"){ ?><th>Division name</th><?php } ?>
                                     <?php if($webinarinfo[0]['re_prob_questions'] == "Yes"){ ?><th>Probable Questions</th><?php } ?>
                                     <?php if($webinarinfo[0]['re_speciality_carbiact'] == "Yes"){ ?><th>Speciality</th><?php } ?>
                                    <?php if($webinarinfo[0]['re_employee_name'] == "Yes"){ ?><th>Employee Name</th><?php } ?>
                                    <?php if($webinarinfo[0]['re_reason_message'] == "Yes"){ ?><th>Reason for not preferring oseltamivir as a first line drug</th><?php } ?>
                                    
                                    <?php if($webinarinfo[0]['re_timeslot'] == "Yes"){ ?><th>Time Slot</th><?php } ?>
                                    <?php if($webinarinfo[0]['re_attend_webinar'] == "Yes"){ ?><th>Would You like to attend this webinar?</th><?php } ?>
							...
							if(!empty($participants)){
                                ...
                                <tr>
                                    ...
                                    <?php if($webinarinfo[0]['re_div_name'] == "Yes"){ ?><td><?php echo $_participants->user_divname; ?></td><?php } ?>
                                    <?php if($webinarinfo[0]['re_prob_questions'] == "Yes"){ ?><td><?php echo $_participants->user_probquestions; ?></td><?php } ?>
                                    <?php if($webinarinfo[0]['re_speciality_carbiact'] == "Yes"){ ?><td><?php echo $_participants->user_specialitycarbiact; ?></td><?php } ?>
                                     <?php if($webinarinfo[0]['re_employee_name'] == "Yes"){ ?><td><?php echo $_participants->user_employeename; ?></td><?php } ?>
                                    <?php if($webinarinfo[0]['re_reason_message'] == "Yes"){ ?><td><?php echo $_participants->user_reasonmessage; ?></td><?php } ?>
                                   
                                    <?php if($webinarinfo[0]['re_timeslot'] == "Yes"){ ?><td><?php echo $_participants->user_timeslot; ?></td><?php } ?>
                                    <?php if($webinarinfo[0]['re_attend_webinar'] == "Yes"){ ?><td><?php echo $_participants->user_attendwebinar; ?></td><?php } ?>
